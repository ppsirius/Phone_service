...
Repair.create!(phone_model: e51, client_id: kowalski.id, status: :sent_to_service, imei: 54867598659, serviceman_id: 1, tag_list: 'simlock, language, soft', max_price: 300, costs: 150, price: 250, deadline: Time.now + 1.week )
Repair.create!(phone_model: iPhone5, client: zbyszkowski, status: :fixed, imei: 54895598659, serviceman_id: 1, tag_list: 'screen', price: 150, deadline: Time.now + 3.day )
Repair.create!(phone_model: nexus, client: potter, imei: 86594331525, serviceman_id: 1, tag_list: 'simlock', price: 400, deadline: Time.now + 5.day )
